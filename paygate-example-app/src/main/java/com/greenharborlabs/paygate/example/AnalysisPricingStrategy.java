...
/**
 * Dynamic pricing strategy that scales the invoice price based on request content length. Requests
 * up to 1 000 bytes pay the default price; larger payloads add 1 sat per 100 bytes of content.
 */
