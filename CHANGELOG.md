...
- **Unsigned location semantics**: Macaroon location remains excluded from authorization and diagnostics but participates in object equality and cache variant replacement.
