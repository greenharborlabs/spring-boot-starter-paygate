...
/**
 * Parsed L402 credential metadata carrying the primary macaroon, any
 * additional macaroons presented alongside it, and the raw authorization
 * header needed for downstream validation by {@code L402Validator}.
 */
