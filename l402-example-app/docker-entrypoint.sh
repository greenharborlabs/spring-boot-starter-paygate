...
if [ "${L402_BACKEND:-}" = "lnbits" ] && [ -z "${L402_LNBITS_API_KEY:-}" ]; then
    LNBITS_URL="${L402_LNBITS_URL:-http://lnbits:5000}"
    echo "==> L402_BACKEND=lnbits but L402_LNBITS_API_KEY is empty."
