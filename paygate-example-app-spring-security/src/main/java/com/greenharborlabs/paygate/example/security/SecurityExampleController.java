...
public class SecurityExampleController {
  ...
  public record ProtocolInfoResponse(
      String tokenId, String protocol, Map<String, String> attributes, String timestamp) {}
  ...
  /**
   * Demonstrates @PreAuthorize with capability-based authorization. Requires both payment AND the
   * "premium-analyze" capability caveat.
   */
  @PaymentRequired(
      priceSats = 25,
