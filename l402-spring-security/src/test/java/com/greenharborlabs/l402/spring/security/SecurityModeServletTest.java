...
/**
 * Verifies that {@code l402.security-mode=servlet} forces servlet filter registration
...
class SecurityModeServletTest {
    ...
    void servletFilterRegistrationCreated() {
        contextRunner.run(context ->
                assertThat(context.containsBean("l402SecurityFilterRegistration")).isTrue());
    }

    @Test
    @DisplayName("L402SecurityFilter bean exists")
    ...
    @Test
    @DisplayName("L402AuthenticationEntryPoint bean does NOT exist")
    void authenticationEntryPointNotCreated() {
        contextRunner.run(context ->
                assertThat(context).doesNotHaveBean(L402AuthenticationEntryPoint.class));
    }

    @Test
    @DisplayName("L402AuthenticationProvider bean does NOT exist")
    void authenticationProviderNotCreated() {
        contextRunner.run(context ->
                assertThat(context).doesNotHaveBean(L402AuthenticationProvider.class));
    }
