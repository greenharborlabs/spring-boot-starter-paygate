 ...
 *       processing. If exhausted, short-circuits with 429.
 ...
 *       endpoint is protected, consumes an additional penalty token.
 * </ol>
 *
  ...
  protected void doFilterInternal(
    ...
    try {
      ...
      log.log(
          ...
          "Endpoint registry threw exception, failing closed: {0}",
          e.getMessage());
