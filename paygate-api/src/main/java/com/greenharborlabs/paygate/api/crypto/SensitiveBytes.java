...
public final class SensitiveBytes implements AutoCloseable, Destroyable {
  ...
  /**
   * Tie-breaker lock for the rare case when two distinct instances have the same {@code
   * System.identityHashCode}. Acquiring this lock first guarantees a total order even when the
   * identity hash codes collide.
   */
  ...
  /**
   * Constant-time equality comparison using {@link CryptoUtils#constantTimeEquals}. Two destroyed
