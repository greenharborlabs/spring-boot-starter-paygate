 ...
 *
 * <p>Each instance carries an {@link ErrorCode} that determines the HTTP status code
 * and RFC 9457 problem type URI for the error response. The optional {@code tokenId}
 * identifies the specific credential that failed validation (safe to log, unlike the
