...
- Approval: Mark Hammond approved only CVE-2025-32013 on the exact 0.1.7 Maven package
  URL through 2026-10-31 UTC in the 2026-09-23 release-preparation conversation.
  The release PR will record the review reference before final validation. PR #84 approved
  only the prior 0.1.7-SNAPSHOT package URL:
  https://github.com/greenharborlabs/spring-boot-starter-paygate/pull/84#issuecomment-5802765603
