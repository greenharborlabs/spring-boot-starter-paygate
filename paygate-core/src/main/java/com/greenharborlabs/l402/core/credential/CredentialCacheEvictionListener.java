...
import com.greenharborlabs.l402.core.macaroon.RootKeyRevocationListener;

import java.util.HexFormat;
import java.util.Objects;

/**
 * Bridges root key revocation events into credential store evictions.
 * When a root key is revoked, the corresponding credential (identified by the
 * hex-encoded key ID) is removed from the credential store.
 */
