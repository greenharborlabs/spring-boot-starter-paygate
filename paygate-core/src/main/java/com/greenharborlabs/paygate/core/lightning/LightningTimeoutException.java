 ...
 *
 * <p>This is a subtype of {@link LightningException} so callers catching the base type will still
 * handle timeouts uniformly. Code that needs to distinguish timeouts from other failures (e.g., for
 * retry logic) can catch this type specifically.
 */
