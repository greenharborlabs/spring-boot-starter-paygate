...
/**
 * Mints new macaroons by computing the HMAC-SHA256 signature chain over the identifier and caveats.
 */
public final class MacaroonMinter {
   ...
   */
  public static Macaroon mint(
      byte[] rootKey, MacaroonIdentifier identifier, String location, List<Caveat> caveats) {
