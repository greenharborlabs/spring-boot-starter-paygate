...
public interface CaveatVerifier {
  ...
  /**
   * Returns whether {@code current} is at least as restrictive as {@code previous} for the same
   * caveat key. Implementations should return {@code false} if the current caveat grants broader
   * access than the previous one (escalation).
   *
