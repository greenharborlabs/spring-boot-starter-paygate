...
public interface LightningBackend {
   ...
   *
   * <p>Implementations MUST return {@code false} on timeout rather than throwing {@link
   * LightningTimeoutException}. This method must never propagate timeout exceptions to callers.
   *
