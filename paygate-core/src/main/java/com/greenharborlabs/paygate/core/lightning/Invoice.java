 ...
 *
 * <p>Byte array fields ({@code paymentHash}, {@code preimage}) are defensively copied on
 * construction and on access to preserve immutability.
 */
public record Invoice(
  ...
  public String toString() {
    return "Invoice[bolt11=" + bolt11 + ", amountSats=" + amountSats + ", status=" + status + "]";
  }
}
