 ...
 *
 * <p>Backend implementations (LND, LNbits, etc.) should extend this class with backend-specific
 * subtypes. Callers can catch {@code LightningException} to uniformly handle lightning failures
 * (e.g., returning HTTP 503).
 */
