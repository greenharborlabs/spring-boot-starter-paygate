 ...
 *
 * <p>This enum captures why a macaroon failed verification at the cryptographic/caveat layer. It
 * intentionally carries no HTTP status codes or protocol-specific semantics.
 */
