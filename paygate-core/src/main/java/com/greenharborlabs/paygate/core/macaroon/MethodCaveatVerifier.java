...
/**
 * Verifies that the request HTTP method matches at least one method specified in the {@code method}
...
public class MethodCaveatVerifier implements CaveatVerifier {
  ...
  public void verify(Caveat caveat, L402VerificationContext context) {
    ...
    String requestMethod = context.getRequestMetadata().get(VerificationContextKeys.REQUEST_METHOD);
