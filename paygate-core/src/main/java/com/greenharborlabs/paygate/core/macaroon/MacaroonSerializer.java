...
/**
 * Serializes and deserializes macaroons in V2 binary format, compatible with Go {@code go-macaroon}
 * library.
 *
 * <p>V2 binary layout:
 *
...
public final class MacaroonSerializer {
  ...
  public static Macaroon deserializeV2(byte[] data) {
    ...
    if ((int) rawSigFieldType != FIELD_SIGNATURE) {
      throw new IllegalArgumentException("Expected signature field type 6, got " + rawSigFieldType);
    }
