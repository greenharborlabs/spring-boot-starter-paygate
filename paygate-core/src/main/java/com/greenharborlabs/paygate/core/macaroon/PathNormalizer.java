...
/**
 * Canonical path normalization for the paygate project. Combines security-defensive
 * iterative percent-decoding with RFC 3986 dot-segment resolution.
 *
 * <p>This is the single source of truth for path normalization. All modules should
 * delegate here rather than implementing their own normalization.
 *
...
public final class PathNormalizer {
     ...
     *   <li>Prepend {@code /} if missing</li>
     *   <li>Iterative percent-decode with convergence check (max 4 total passes),
     *       preserving reserved delimiters {@code %2F}, {@code %3F}, {@code %23}, {@code %3A}</li>
     *   <li>Collapse consecutive slashes</li>
     *   <li>Resolve dot-segments per RFC 3986 Section 5.2.4</li>
     *   <li>Strip trailing slash unless root</li>
     * </ol>
     */
     ...
     * Reserved delimiters ({@code %2F}, {@code %3F}, {@code %23}, {@code %3A})
     * are preserved with uppercased hex digits per RFC 3986 Section 2.1.
     *
     * <p>Invalid hex digits after {@code %} and incomplete sequences pass through unchanged.
     * Plus sign is treated as literal (not space).
     */
    ...
    /**
     * Iteratively percent-decodes until output converges or the iteration limit is reached.
     * Maximum 4 total decode passes (1 initial + up to 3 iterations).
     */
