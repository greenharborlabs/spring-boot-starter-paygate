...
/**
 * Unsigned LEB128 (varint) encoding and decoding, compatible with protobuf varint and Go {@code
 * binary.PutUvarint} / {@code binary.Uvarint}.
 *
...
public final class Varint {
   ...
   * @throws IllegalArgumentException if input is null, offset is out of bounds, or the varint is
   *     truncated
   */
