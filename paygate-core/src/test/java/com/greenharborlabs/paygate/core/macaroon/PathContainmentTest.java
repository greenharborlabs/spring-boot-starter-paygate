...
class PathContainmentTest {
    ...
    class DoubleStarContainment {
        ...
        void doubleStarContainsNarrowerDoublestar() {
            assertThat(PathGlobMatcher.isContainedIn("/api/**", "/api/products/**"))
                    .isTrue();
        }
        ...
        void narrowerDoublestarDoesNotContainBroader() {
            assertThat(PathGlobMatcher.isContainedIn("/api/products/**", "/api/**"))
                    .isFalse();
        }
        ...
        void doubleStarPrefixMismatch() {
            assertThat(PathGlobMatcher.isContainedIn("/api/**", "/orders/products"))
                    .isFalse();
            assertThat(PathGlobMatcher.isContainedIn("/api/**", "/orders/**"))
                    .isFalse();
        }
    }
    ...
    class SingleStarContainment {
        ...
        void singleStarInMiddleContainsLiteral() {
            assertThat(PathGlobMatcher.isContainedIn("/api/*/details", "/api/orders/details"))
                    .isTrue();
        }
    }
    ...
    class IdenticalPatterns {
        ...
        void identicalLiterals() {
            assertThat(PathGlobMatcher.isContainedIn("/api/products", "/api/products"))
                    .isTrue();
        }
    ...
    class DisjointPatterns {
        ...
        void disjointPatterns() {
            assertThat(PathGlobMatcher.isContainedIn("/api/products", "/orders/items"))
                    .isFalse();
        }
        ...
        void partialOverlap() {
            assertThat(PathGlobMatcher.isContainedIn("/api/products", "/api/orders"))
                    .isFalse();
        }
    }
    ...
    class SegmentCountMismatches {
        ...
        void proposedFewerSegmentsNoDoublestar() {
            assertThat(PathGlobMatcher.isContainedIn("/api/products/details", "/api/products"))
                    .isFalse();
        }
        ...
        void proposedMoreSegmentsNoDoublestar() {
            assertThat(PathGlobMatcher.isContainedIn("/api/products", "/api/products/details"))
                    .isFalse();
        }
    }
    ...
    class ConservativeRejection {
        ...
        void ambiguousWildcardPatternsRejected() {
            ...
            assertThat(PathGlobMatcher.isContainedIn("/api/*/items", "/api/*/details"))
                    .isFalse();
        }
        ...
        void singleStarProposedVsLiteralExisting() {
            ...
            assertThat(PathGlobMatcher.isContainedIn("/api/orders", "/api/*"))
                    .isFalse();
        }
    }
