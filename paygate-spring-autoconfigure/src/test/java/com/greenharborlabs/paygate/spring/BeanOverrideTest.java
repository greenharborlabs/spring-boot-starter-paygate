...
/**
 * Verifies that {@link PaygateAutoConfiguration} respects {@code @ConditionalOnMissingBean} for
 * {@link RootKeyStore}: a user-defined bean must suppress the auto-configured one.
 */
  ...
  static class CustomRootKeyStore implements RootKeyStore {
    ...
    public GenerationResult generateRootKey() {
      return new GenerationResult(
          new com.greenharborlabs.paygate.api.crypto.SensitiveBytes(new byte[32]), new byte[32]);
    }
