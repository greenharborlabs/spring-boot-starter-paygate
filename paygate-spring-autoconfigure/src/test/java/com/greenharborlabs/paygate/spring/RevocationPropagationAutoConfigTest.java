...
/**
 * Integration tests verifying that root key revocation propagates to credential cache eviction
 * through the auto-configured {@link ObservableRootKeyStore} and {@link
 * com.greenharborlabs.paygate.core.credential.CredentialCacheEvictionListener}.
 */
...
class RevocationPropagationAutoConfigTest {
    ...
    contextRunner
        ...
        .run(
            context -> {
              ...
              assertThat(store)
                  .isSameAs(context.getBean(PreWrappedRootKeyStoreConfig.class).preWrapped);
            });
  }
  ...
  static class PreWrappedRootKeyStoreConfig {
    final ObservableRootKeyStore preWrapped = new ObservableRootKeyStore(new CustomRootKeyStore());
