...
/**
 * Verifies that the WWW-Authenticate header in 402 challenge responses uses only the {@code L402}
 * scheme and never the legacy {@code LSAT} scheme (T096, T098).
 */
    ...
    PaygateEndpointRegistry paygateEndpointRegistry() {
      ...
      registry.register(
          new PaygateEndpointConfig(
              "GET", PROTECTED_PATH, PRICE_SATS, 600, "Scheme test endpoint", "", ""));
      return registry;
    }
