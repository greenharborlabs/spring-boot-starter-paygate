 ...
 *
 * <p>Implementations are looked up as Spring beans by name, as specified in {@link
 * PaymentRequired#pricingStrategy()}. When a matching bean is found, the strategy determines the
 * invoice price instead of the static {@code priceSats} annotation value.
 */
@FunctionalInterface
