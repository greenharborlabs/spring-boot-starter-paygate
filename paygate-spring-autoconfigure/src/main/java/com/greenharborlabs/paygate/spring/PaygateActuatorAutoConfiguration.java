 ...
 * required L402 beans are present. Separated from {@link PaygateAutoConfiguration}
...
@ConditionalOnProperty(name = "paygate.actuator.enabled", havingValue = "true", matchIfMissing = true)
