...
/**
 * Checked exception thrown when the Lightning backend is unhealthy or a Lightning operation
 * (invoice creation, key generation) fails. Callers should respond with HTTP 503 Service
 * Unavailable.
 */
