 ...
 *
 * <p>Caches the health result for a configurable duration to avoid hammering the Lightning node on
 * every actuator scrape.
 */
public class PaygateLightningHealthIndicator implements HealthIndicator {
  ...
  public PaygateLightningHealthIndicator(LightningBackend backend, long cacheTtlMillis) {
