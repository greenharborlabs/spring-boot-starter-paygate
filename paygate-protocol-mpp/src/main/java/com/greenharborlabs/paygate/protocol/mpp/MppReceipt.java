...
public final class MppReceipt {
   ...
   * @throws IllegalArgumentException if credential metadata is not {@link MppMetadata} or the
   *     echoed challenge does not contain an "id" entry
   */
  public static PaymentReceipt from(PaymentCredential credential, ChallengeContext context) {
    ...
    return new PaymentReceipt(
        "success", challengeId, "lightning", null, context.priceSats(), timestamp, "Payment");
  }
}
