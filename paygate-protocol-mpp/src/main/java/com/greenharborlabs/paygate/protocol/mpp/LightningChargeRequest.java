...
public record LightningChargeRequest(
    String amount, String currency, String description, MethodDetails methodDetails) {
   ...
   */
  public record MethodDetails(String invoice, String paymentHash, String network) {
    ...
    /**
     * Returns a JCS-ordered map of these method details. Key order: invoice, network, paymentHash
     * (lexicographic).
     */
  ...
  /**
   * Converts this charge request to a {@link Map} suitable for {@code JcsSerializer.serialize()}.
   *
   * <p>Keys are in JCS (RFC 8785) lexicographic order: {@code amount}, {@code currency}, {@code
   * description} (if non-null), {@code methodDetails}.
   *
