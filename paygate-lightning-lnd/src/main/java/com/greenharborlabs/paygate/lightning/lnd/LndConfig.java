...
public record LndConfig(
  ...
  /**
   * Creates a config with sensible defaults for connection management fields. {@code
   * allowPlaintext} defaults to {@code false}.
   */
  public static LndConfig withDefaults(
      String host, int port, String tlsCertPath, String macaroonPath) {
