...
/**
 * Unit tests for {@link L402ResponseWriter}.
 */
@DisplayName("L402ResponseWriter")
class L402ResponseWriterTest {
    ...
    void writeMalformedHeader_setsStatusAndBody() throws Exception {
        L402ResponseWriter.writeMalformedHeader(response, "bad header format", "tok-123");
    ...
    void writeMalformedHeader_nullTokenIdRendersEmpty() throws Exception {
        L402ResponseWriter.writeMalformedHeader(response, "bad", null);
    ...
    void writeMalformedHeader_escapesTokenId() throws Exception {
        L402ResponseWriter.writeMalformedHeader(response, "bad", "tok\"with\nnewline");
    ...
    void writeValidationError_setsStatusAndBody() throws Exception {
        L402ResponseWriter.writeValidationError(response, ErrorCode.INVALID_MACAROON,
    ...
    void writeValidationError_nullTokenIdRendersEmpty() throws Exception {
        L402ResponseWriter.writeValidationError(response, ErrorCode.EXPIRED_CREDENTIAL,
                "expired", null);
    ...
    void writeValidationError_usesCorrectStatusPerErrorCode() throws Exception {
        L402ResponseWriter.writeValidationError(response, ErrorCode.LIGHTNING_UNAVAILABLE,
                "down", "tok-789");
